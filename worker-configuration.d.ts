/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: d3916ec4c246267c0d3a3414aed64e49)
// Runtime types generated with workerd@1.20251011.0 2025-03-25 nodejs_compatnpx wrangler types --env-interface CloudflareEnv
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_CLOUDFLARE_CDN_URL: string;
		NEXT_PUBLIC_SITE_URL: string;
		AUTH_SECRET: string;
		AUTH_GOOGLE_ID: string;
		AUTH_GOOGLE_SECRET: string;
		onlinegemini: Hyperdrive;
		ASSETS: Fetcher;
	}
}
